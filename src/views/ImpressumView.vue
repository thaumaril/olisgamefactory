<template>
  <div class="page container">
    <div class="prose" style="max-width:760px;">
      <h1>Impressum</h1>
      <p style="color:var(--text-dim);">Angaben gemäß § 5 TMG</p>
      ...
      <p>
        ...
        Meine E-Mail-Adresse findest du oben im Abschnitt Kontakt.
      </p>
      <p>
      ...
      <p>
        ...
        möglich. Bei Bekanntwerden von entsprechenden Rechtsverletzungen werde ich diese Inhalte
        umgehend entfernen.
      </p>
